            ...
            <ul class="menu">
                ...
                @if (Auth::check())
                    @if (Auth::user()->role === 'mahasiswa')
                        ...
                        <li class="sidebar-item {{ request()->routeIs('mahasiswa.formskpi') ? 'active' : '' }}">
                            <a href="{{ route('mahasiswa.formskpi') }}" class="sidebar-link">
                    ...
                    @elseif(Auth::user()->role === 'admin_prodi')
                        <li class="sidebar-item {{ request()->routeIs('prodi.dashboard') ? 'active' : '' }}">
                            <a href="{{ route('prodi.dashboard') }}" class="sidebar-link">
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{ request()->routeIs('prodi.verifikasi') ? 'active' : '' }}">
                            <a href="{{ route('prodi.verifikasi') }}" class="sidebar-link">
                    ...
                    @elseif(Auth::user()->role === 'admin_fakultas')
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.fakultas.prodi') ? 'active' : '' }}">
                            <a href="{{ route('admin.fakultas.prodi') }}" class="sidebar-link">
